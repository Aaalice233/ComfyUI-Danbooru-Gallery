...
try:
    from .DebugTools import NODE_CLASS_MAPPINGS as debug_mappings, NODE_DISPLAY_NAME_MAPPINGS as debug_display_mappings
except Exception as e:
    logger.error(f"导入 DebugTools 节点失败: {e}")
    debug_mappings, debug_display_mappings = {}, {}


# 合并所有节点的映射
NODE_CLASS_MAPPINGS = {**danbooru_mappings, **swap_mappings, **ps_mappings, **mce_mappings, **gem_mappings, **cache_save_mappings, **cache_get_mappings, **debug_mappings}
NODE_DISPLAY_NAME_MAPPINGS = {**danbooru_display_mappings, **swap_display_mappings, **ps_display_mappings, **mce_display_mappings, **gem_display_mappings, **cache_save_display_mappings, **cache_get_display_mappings, **debug_display_mappings}
